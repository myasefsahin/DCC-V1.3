...
new Paragraph(
    ...
    new TableProperties(
     ...
     new Run(
        ...
        #endregion
        #region Create For Six Row
        public Table CreateForSixRow(ArrayList Freq, ArrayList Value1, ArrayList Value1Unc, ArrayList Value2, ArrayList Value2Unc, ArrayList Value3, ArrayList Value3_Unc)
        {
            ...
            for (int i = 0; i < Freq.Count; i++)
            {
                TableRow dataRow = new TableRow(
                    ...
                    new TableCell(new TableCellProperties(new TableCellWidth() { Type = TableWidthUnitValues.Dxa, Width = cellWidth.ToString() }),
                        new Paragraph(new Run(
                            new RunProperties(new RunFonts() { Ascii = "Arial", HighAnsi = "Arial" }),
                            new Text(Value3_Unc[i].ToString()))))
                );
