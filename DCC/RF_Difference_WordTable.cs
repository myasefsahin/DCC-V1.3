...
namespace DCC
{
    ...
    {
        public Table RF_Diff_Table(ArrayList col1, ArrayList col2, ArrayList col3, ArrayList col4, ArrayList col5, ArrayList col6, ArrayList col7,string Col1, string Col2, string Col3, string Col4, string Col5, string Col6, string Col7)
        {
            // Tablo özellikleri
